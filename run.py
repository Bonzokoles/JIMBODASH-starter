...
try:
    ...
    print("Please ensure the backend directory and server.py file exist.")
    print("Also, make sure you have installed the dependencies using 'pip install -r requirements.txt'.")
